	    ...
	    <div class="kt-portlet__head">
			<div class="kt-portlet__head-label">
				...
				<h3 class="kt-portlet__head-title">
					{{ __('timeInOutManagement') }} <i class="fas fa-angle-double-right"></i> {{ __('add') }}
				</h3>
			</div>
		</div>

        <form method="POST" action="admin/list-employee/create/{{$id}}">
        @csrf
            <div class="kt-portlet__body">
				<div class="row">
                    ...
                    <div class="col-xl-9">
                        <input class="form-control" type="text" name="user_id" value = "{{$id}}" readonly >
                    </div>
                    <div class="col-xl-3">
                    ...
                    <div class="col-xl-9">
                        <input  class="form-control" type="date" name="interactive_date" value="{{$today}}">
                    </div>
                    <div class="col-xl-3">
                        <label class="col-form-label">Giờ: </label>
                    </div>
                    <div class="col-xl-9">
                        <input  class="form-control" type="time" name="interactive_time" value="{{$current_time}}">
                    </div>
